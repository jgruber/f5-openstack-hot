...
function set_vars() {
    ...
    vlan_creates=$bigip_vlan_creates
    vlan_names=$bigip_vlan_names
    vlan_tags=$bigip_vlan_tags
    vlan_mtus=$bigip_vlan_mtus
    vlan_nics=''
    vlan_nic_count=$bigip_nic_count
    ...
    self_port_lockdowns=$bigip_self_port_lockdowns
    self_ips=$bigip_self_ip_addrs
    self_ip_names=''
    self_ip_cidrs=$bigip_self_cidrs
    ...
    if [[ "$bigip_default_gateway" != "None" && "$bigip_default_gateway" != "" ]]; then
        default_gateway="${bigip_default_gateway}"
