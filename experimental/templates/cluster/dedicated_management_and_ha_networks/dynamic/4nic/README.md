...
## Prerequisites and Configuration Notes
  - The HA (Highly Available) solution consists of two templates that configure clustering:
    - *f5_bigip_cluster_4_nic.yaml*, the parent template that needs to be specified as the template parameter.
    - *f5_bigip_cluster_instance_4_nic.yaml*, the BIG-IP instance-specific template referenced by the parent template.
